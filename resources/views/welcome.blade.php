...
<body class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 py-16">
        <div class="text-center">
            ...
            <p class="text-xl text-gray-600 mb-8">Esta es la API de backend de la plataforma de Servicity</p>
            ...
            <div class="bg-white rounded-xl shadow-md p-8">
                ...
                <p class="inline-block px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors">
